  ...
  export default {
    ...
    mounted() {
      ...
      this.svg = d3.select(this.$el)
        .attr('class', 'ckt_svg_columnChart');
    ...
    methods: {
      ...
      initXScale() {
        ...
        this.xScale = d3.scaleLinear()
          .rangeRound([this.boxWidth, 0])
          .domain([d3.max(this.dataList.map(function (d) {
            return d.value + 20
          })), 0]);
      },
      initYScale() {
      ...
      drawLegend() {
        ...
        let textList = this.svg.append('g')
          ...
          .attr('transform', 'translate(' + (this.margin.left - 5) + ',' + (this.boxHeight + 5) + ')')
          .selectAll('.legend')
          .data(this.list)
          .enter()
          .append('g')
