  ...
  export default {
    ...
    methods: {
      ...
      drawChart() {
        ...
        this.group.selectAll('.lineCircle')
          .data(this.list)
          .enter()
          .append('circle')
        ...
        this.group.selectAll('.lineOuterCircle')
          .data(this.list)
          .enter()
          .append('circle')
...
//        });
        ...
        let line = d3.line()
          ...
          .y((d) => this.yScale(d.value));
        // .curve(d3.curveCatmullRom.alpha(1));//如果需要设置曲线,放开代码即可
        let lineClipId = new Date().getTime();
        this.group.append('path')
          .datum(this.list)
          .attr("fill", "none")
          .attr("stroke", "rgb(82,180,255)")
