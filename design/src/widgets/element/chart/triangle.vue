  ...
  export default {
    ...
    mounted() {
      ...
      this.svg = d3.select(this.$el)
        .attr('class', 'ckt_svg_triangleChart');
    ...
    methods: {
      ...
      drawChart() {
        ...
        this.group.selectAll('polygon')
          ...
          .attr('points', (d) => {
            ...
            a.centerY = this.boxHeight - this.margin.bottom - this.yScale(d.value);
            a.end = this.xScale.bandwidth();
            arr.push(a.centerX + ',');
            arr.push('0');
            arr.push(' ');
            arr.push(a.centerX * 2 + ',');
            arr.push(a.centerY);
            arr.push(' 0,');
            arr.push(a.centerY);
            return arr.join('');
          ...
          .attr('transform', (d) => {
            return 'translate(' + this.xScale(d.name) + ',' + (this.yScale(d.value) - 1) + ')'
          })
      ...
      animate() {
        ...
        this.group.selectAll('polygon')
          ...
          .attr('transform', (d) => {
            return 'translate(' + this.xScale(d.name) + ',' + (this.boxHeight - this.margin.bottom - 1) + ')'
          })
          .on('mouseenter', function (d) {
            let self = this;
            that.enter(d, self)
